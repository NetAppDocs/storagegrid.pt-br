...
---
= Topologia de rede do cliente para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_client_networks.png["Redes de clientes Grid"]

image:grid_client_networks_ips.png["IPs redes Cliente Grid"]
