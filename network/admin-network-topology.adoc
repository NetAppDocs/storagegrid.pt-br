...
---
= Topologia de rede de administração para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_admin_networks.png["Redes de administração da grade"]

image:grid_admin_networks_ips.png["IPs de redes de administrador de grade"]
