...
summary: Restaure o banco de dados do nó de administração ao recuperar um nó de administração primário usando um nó de administração não primário. 
---
= Restaure o banco de dados do nó de administração do StorageGRID ao recuperar o nó de administração primário
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Adicione a chave privada SSH ao agente SSH. Digite: `ssh-add`
...
.. Quando você não precisar mais de acesso sem senha a outros servidores, remova a chave privada do agente SSH. Digite: `ssh-add -D`
