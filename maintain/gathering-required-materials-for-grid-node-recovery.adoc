...
---
= Reúna os materiais necessários para a recuperação do nó da grade StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
O conteúdo do `.zip` os arquivos são atualizados sempre que o sistema é modificado.  Você será instruído a armazenar a versão mais recente do pacote de recuperação em um local seguro após fazer essas alterações.  Use a cópia mais recente para se recuperar de falhas na rede.

Quando estiver conectado a qualquer nó de administração, use o Grid Manager para baixar um pacote de recuperação.  Selecione *Manutenção* > *Sistema* > *Pacote de recuperação*.
...
. Vá para a seção apropriada para sua plataforma para escolher os arquivos necessários, com base na sua plataforma e em quais nós de grade você precisa recuperar.
+
