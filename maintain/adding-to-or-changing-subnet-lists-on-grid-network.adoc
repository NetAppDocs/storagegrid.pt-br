...
---
= Adicionar ou alterar listas de sub-redes na Grid Network no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif["captura de tela descrita pelo texto circundante"]
...
+
image:change_ip_tool_gnsl_sample_output.gif["captura de tela descrita pelo texto circundante"]
