...
---
= Veja o status atual de todos os serviços do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:storagegrid_status_output.gif["captura de tela da saída de comando da grade de armazenamento"]
