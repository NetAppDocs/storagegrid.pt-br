...
---
= Aplicar um hotfix no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:software_update_landing.png["Página inicial de atualização de software"]
...
+
image:hotfix_choose_file.png["Escolha Arquivo"]
...
+
image:hotfix_progress_table.png["Tabela de progresso do hotfix"]
...
+
image:approve_all_progresstable.png["Progresso do hotfix com o botão remover"]
