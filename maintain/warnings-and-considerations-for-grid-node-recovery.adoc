...
---
= Avisos e considerações para recuperação de nós do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Se você estiver recuperando um nó da grade que não seja o nó de administração principal, deve haver conectividade entre o nó da grade que está sendo recuperado e o nó de administração que gerencia o procedimento de recuperação.
...
Se um servidor que hospeda mais de um nó de grid falhar, você pode recuperar os nós em qualquer ordem. No entanto, se o servidor com falha estiver hospedando o Admin Node primário e não existirem Admin Nodes não primários, você deve recuperar primeiro o Admin Node primário.
