...
Se um servidor que hospeda mais de um nó de grade falhar, você poderá recuperar os nós em qualquer ordem. No entanto, se o servidor com falha estiver hospedando o Nó de Administração primário e não existirem Nós de Administração secundários, você deverá recuperar primeiro o Nó de Administração primário.
