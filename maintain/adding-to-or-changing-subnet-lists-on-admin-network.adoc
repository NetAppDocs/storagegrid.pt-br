...
---
= Adicionar ou alterar listas de sub-redes na Admin Network no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif["altere o exemplo aesl da ferramenta ip"]
...
NOTE: Se você selecionou qualquer um dos modos de seleção de "todos" nós na etapa 3, pressione *Enter* (sem *q*) para ir para o próximo nó na lista.
...
+
image:change_ip_tool_aesl_sample_output.png["captura de tela descrita pelo texto circundante"]
