...
---
= Recuperação do nó Admin primário ou não primário no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Opções
* link:recovering-from-primary-admin-node-failures.html["Recupere o nó de administração primário usando o mesmo nó de administração primário"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["Recupere falhas do nó de administração primário usando um nó de administração não primário"]
