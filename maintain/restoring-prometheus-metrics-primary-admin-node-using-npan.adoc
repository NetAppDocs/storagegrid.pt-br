...
summary: Restaurar métricas do Prometheus ao recuperar um nó de administração primário usando um nó de administração não primário. 
---
= Restaurar métricas do Prometheus ao recuperar um nó de administração primário do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
