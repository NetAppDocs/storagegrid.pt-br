...
---
= Substitua um nó VMware no StorageGRID por um nó de recuperação
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nós de administração
 a| 
link:recovering-from-admin-node-failures.html["Recuperação do nó Admin primário ou não primário no StorageGRID"]
