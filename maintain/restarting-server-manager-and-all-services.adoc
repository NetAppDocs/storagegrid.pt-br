...
summary: Você pode precisar reiniciar Server Manager e todos os serviços em execução em um nó de grid. 
---
= Reinicie StorageGRID Server Manager e todos os serviços
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode precisar reiniciar Server Manager e todos os serviços em execução em um nó de grid.
