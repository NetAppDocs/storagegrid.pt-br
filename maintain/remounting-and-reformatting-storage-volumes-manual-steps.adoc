...
---
= Remontar e reformatar volumes de armazenamento do StorageGRID (etapas manuais)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Na maioria dos casos, você deve link:../maintain/restoring-object-data-to-storage-volume.html["Restaure dados de objetos usando o Gerenciador de Grade"]. Responda `y` para usar o Grid Manager.
