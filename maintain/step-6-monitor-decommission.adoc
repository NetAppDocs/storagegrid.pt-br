...
---
= Monitorar o progresso da desativação do site no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_6_recovery_package.png["Pacote de recuperação da Etapa 6 de descomissionamento do local"]
...
+
image:decommission_site_step_6_data_movement.png["Etapa 6 movimento de dados do local"]
...
+
image:decommission_site_step_6_storage_node.png["Desativar nó de storage passo 6 do local"]
...
+
image:decommission_site_step_6_repair_cassandra.png["Etapa 6 reparar Cassandra"]
...
+
image:decommission_site_step_6_remove_configuration.png["Etapa 6 Remover configuração do local de desativação"]
...
+
image:decommission_site_success_message.png["Desativar mensagem de sucesso do local"]
