...
---
= Restaurar o banco de dados do nó administrativo do StorageGRID ao recuperar um nó administrativo não primário
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Dados históricos de atributos, que são usados em gráficos na página de Nodes
