...
---
= Desativar nós StorageGRID conectados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Todos os nós da grade têm saúde Normal (verde) image:icon_alert_green_checkmark.png["ícone de marca de verificação verde"]. Se você vir um destes ícones na coluna *Saúde*, você deve tentar resolver o problema:
+
[cols="1a,1a,3a"]
|===
| Ícone | Cor | Gravidade 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["ícone quadrado amarelo"]
 a| 
Amarelo
 a| 
Aviso
 ...
 a| 
image:icon_alert_yellow_minor.png["ícone de diamante laranja claro"]
 a| 
Laranja claro
 a| 
Menor
 ...
 a| 
image:icon_alert_orange_major.png["ícone de diamante laranja escuro"]
 a| 
Laranja escuro
 a| 
Maior
 ...
 a| 
image:icon_alert_red_critical.png["ícone vermelho x"]
 a| 
Vermelho
 a| 
Crítico
