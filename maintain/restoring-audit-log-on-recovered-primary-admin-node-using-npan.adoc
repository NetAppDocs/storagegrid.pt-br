...
summary: Restaure o log de auditoria no nó de administração primário recuperado usando um nó de administração não primário. 
---
= Restaure o log de auditoria do StorageGRID em um nó de administração primário recuperado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Verlink:../monitor/configure-log-management.html["Configurar gerenciamento de log e servidor syslog externo"] para mais detalhes.
