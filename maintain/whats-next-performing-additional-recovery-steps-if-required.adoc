...
---
= Execute etapas adicionais de recuperação do nó StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nó de administração principal
 a| 
* link:selecting-start-recovery-to-configure-primary-admin-node.html["Selecione Iniciar Recuperação para configurar o nó Admin primário"]
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["Recupere o nó de administração primário usando um nó de administração não primário"]
