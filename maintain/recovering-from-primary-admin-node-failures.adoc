...
---
= Recupere o nó de administração primário do StorageGRID usando o mesmo nó de administração primário
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Você deve reparar ou substituir imediatamente um nó de administração primário com defeito ou talvez não consiga executar determinados procedimentos de manutenção.
