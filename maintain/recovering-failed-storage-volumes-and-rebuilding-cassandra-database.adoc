...
---
= Recuperar volumes de storage com falha e reconstruir o banco de dados Cassandra no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Após os volumes de armazenamento serem reformatados e remontados e as operações necessárias do Cassandra serem concluídas, você pode link:../maintain/restoring-object-data-to-storage-volume-where-system-drive-is-intact.html["Restaure dados de objetos usando o Gerenciador de Grade"].
