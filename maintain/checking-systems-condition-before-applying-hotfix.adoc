...
---
= Verifique a condição do sistema antes de aplicar um hotfix do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Os nós conectados têm marcas de seleção verdes image:icon_alert_green_checkmark.png["marca de verificação verde de alerta do ícone"] na página Nós.
