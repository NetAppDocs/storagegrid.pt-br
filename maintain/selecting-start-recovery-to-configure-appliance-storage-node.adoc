...
+
image:recovery_reset_button.gif["captura de tela mostrando o estágio aguardando etapas manuais"]
...
+
image:recovery_reset_warning.gif["captura de tela mostrando a caixa de diálogo de aviso de recuperação de redefinição"]
