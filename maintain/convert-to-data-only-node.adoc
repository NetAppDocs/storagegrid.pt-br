...
---
= Converter um nó de armazenamento StorageGRID em um nó somente de dados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Se o Nó de Armazenamento contiver o serviço ADC, mais de dois Nós de Armazenamento ADC estiverem online na grid e Nós de Armazenamento não-ADC estiverem disponíveis no mesmo site para hospedar o serviço ADC.
...
.Sobre esta tarefa
Use este procedimento para converter um ou mais nós de armazenamento combinados em nós somente de dados. Se um nó de armazenamento contiver o serviço ADC, o serviço será movido automaticamente para outro nó de armazenamento no mesmo site durante a conversão.
...
NOTE: StorageGRID move o serviço ADC para os Storage Nodes mais recentes que atendem aos requisitos para hospedar o serviço.
