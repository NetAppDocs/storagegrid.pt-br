...
---
= Restaurar os dados do objeto usando StorageGRID Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Você confirmou que o Nó de Armazenamento onde está restaurando objetos tem um Estado de Conexão *Conectado* image:icon_alert_green_checkmark.png["marca de verificação verde de alerta do ícone"] na guia *Nodes* > *Overview* do Grid Manager.
