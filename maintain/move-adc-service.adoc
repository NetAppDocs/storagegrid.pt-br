...
---
= Mover o serviço ADC no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
Use o procedimento Mover ADC para mover manualmente o serviço ADC entre Storage Nodes. Por exemplo, você pode querer redistribuir os serviços ADC entre Storage Nodes ou mover o serviço ADC para um Storage Node de maior desempenho.
...
[NOTE]
====
* Você não precisa mover manualmente o serviço ADC antes de link:../maintain/convert-to-data-only-node.html["Convertendo um nó de armazenamento em um nó somente de dados"] ou desativar um Storage Node. Esses procedimentos movem automaticamente o serviço ADC quando necessário. Consulte link:../maintain/understanding-adc-service-quorum.html["O que é o quórum do ADC?"] para obter detalhes sobre os requisitos.
* StorageGRID move o serviço ADC para os Storage Nodes mais recentes que atendem aos requisitos para hospedar o serviço.
