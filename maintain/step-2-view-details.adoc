...
summary: 'Na Etapa 2 (Exibir detalhes) do assistente Decommission Site, você pode analisar quais nós estão incluídos no site, ver quanto espaço foi usado em cada nó de armazenamento e avaliar quanto espaço livre está disponível nos outros sites da sua grade.' 
---
= Analise os detalhes do site antes da desativação no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_2_site_warnings.png["Desativar Site passo 2 Avisos de local"]
...
** O site contém uma mistura de nós conectados (image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"]) e desconectados (image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"] ou image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"]). Antes de remover este site, você deve trazer todos os nós offline de volta online.


. Reveja os detalhes sobre o site que selecionou para remover.
+
image:decommission_site_step_2_view_details.png["Etapa 2 Exibir detalhes do site"]
...
+
*** image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"] (Conectado)
*** image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"] (Administrativamente inativo)
*** image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"] (Desconhecido)
...
+
image:decommission_site_step_2_view_details_for_other_sites.png["Etapa 2 Exibir detalhes para outros sites"]
