...
---
= Pausar e retomar o processo de desativação para nós de armazenamento do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_nodes_procedure_paused.png["Procedimento de desativação dos nós em pausa"]
