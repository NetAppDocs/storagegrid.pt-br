...
summary: 'Talvez seja necessário desativar um nó que não esteja conetado à grade no momento (aquele cuja Saúde é desconhecida ou administrativamente inativa).' 
---
...
.Sobre esta tarefa
Você pode identificar nós desconectados procurando o ícone azul "Desconhecido" image:icon_alarm_blue_unknown.png["Ícone desconhecido"] ou o ícone cinza "Administrativamente inativo" image:icon_alarm_gray_administratively_down.png["Ícone administrativamente para baixo"] na coluna *Saúde*.
...
. Analise a lista de nós e selecione *OK*.
+
...
. Assim que o novo pacote de recuperação estiver disponível, selecione o link ou selecione *Manutenção* > *Sistema* > *Pacote de recuperação* para acessar a página do pacote de recuperação. Em seguida, faça o download do  `.zip`arquivo.
+
...
--
Para monitorar o reparo de dados codificados em apagamento e tentar novamente quaisquer solicitações que possam ter falhado, selecione *Support* > *Tools* > *Metrics* para visualizar o tempo estimado de conclusão e a porcentagem de conclusão da tarefa atual. Em seguida, selecione *EC Overview* na seção Grafana. Observe os painéis *Grid EC Job Estimated Time to Completion* e *Grid EC Job Percentage Completed*.
