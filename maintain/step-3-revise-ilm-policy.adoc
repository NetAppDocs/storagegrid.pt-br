...
summary: 'A partir do passo 3 (rever as políticas ILM) do assistente do site Decommission, você pode determinar se o site é referido por qualquer política ILM.' 
---
= Revisar as políticas de ILM para desativação de site no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
