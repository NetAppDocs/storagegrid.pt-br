...
NOTE: Se um site contém uma mistura de nós conectados (image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"]) e desconectados (image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"] ou image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"]), você deve trazer todos os nós offline de volta online.
...
* Você não pode desativar um site se ele contiver uma mistura de nós conectados (image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"]) e desconectados (image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"] ou image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"]).
* Você não pode desativar um site se qualquer nó em qualquer outro site estiver desconectado (image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"] ou image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"]).
...
* Todos os nós do seu sistema StorageGRID devem ter um Estado de Conexão de *Conectado* (image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"]); no entanto, os nós podem ter alertas ativos.
+
...
+
** *Desconhecido* (image:icon_alarm_blue_unknown.png["Ícone alarme azul desconhecido"]): Por um motivo desconhecido, um nó está desconectado ou os serviços no nó estão inesperadamente inativos. Por exemplo, um serviço no nó pode ter sido interrompido ou o nó pode ter perdido sua conexão de rede devido a uma falha de energia ou interrupção inesperada.
** *Administrativamente Inativo* (image:icon_alarm_gray_administratively_down.png["Ícone alarme cinza administrativamente para baixo"]): O nó não está conectado à grid por um motivo esperado. Por exemplo, o nó ou os serviços no nó foram desligados normalmente.


* Todos os nós em todos os outros sites devem ter um Estado de Conexão de *Conectado* (image:icon_alert_green_checkmark.png["Marca de verificação Icon Alert Green"]); no entanto, esses outros nós podem ter alertas ativos.
