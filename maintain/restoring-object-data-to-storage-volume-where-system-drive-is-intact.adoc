...
.Antes de começar
* Você confirmou que o nó de armazenamento recuperado tem um estado de conexão *Conectado* image:icon_alert_green_checkmark.png["marca de verificação verde de alerta do ícone"] na guia *Nós* > *Visão geral* do Grid Manager.
