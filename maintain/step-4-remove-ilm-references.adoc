...
summary: 'No passo 4 (Remover referências ILM) do assistente Decommission Site, você deve excluir ou editar quaisquer regras ILM não utilizadas que se referem ao site, mesmo que as regras não sejam usadas em nenhuma política ILM.' 
---
= Remova referências ILM a um site no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Para excluir uma regra, selecione o ícone da lixeira image:icon_trash_can.png["Ícone Lixeira"] e selecione *OK*.
+
