...
---
= Copie os logs de auditoria do StorageGRID de um nó de administração primário com falha
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Digite o seguinte comando para alternar para a conta do usuário raiz: `su -`
.. Introduza a palavra-passe listada no `Passwords.txt` ficheiro.
+
...
+
Quando solicitado, digite a senha da conta de usuário admin.
...
. Sair da sessão como usuário raiz: `exit`.
