...
. Na página de detalhes do endpoint, selecione *Conexão*. Esta aba exibe apenas o erro mais recente para um endpoint e indica há quanto tempo o erro ocorreu. Erros que incluem o ícone X vermelho image:icon_alert_red_critical.png["Ícone X vermelho"] ocorreram nos últimos 7 dias.
