...
+
image:grid-federation-post-current-user-replicate.png["POST endpoint para replicar a própria chave de acesso"]
...
+
image:grid-federation-clone-access-key.png["API do Gerenciador de inquilinos inserindo valores para clonar a chave de acesso"]
...
+
image:grid-federation-post-other-user.png["POST endpoint para replicar a chave de acesso de outro usuário"]
