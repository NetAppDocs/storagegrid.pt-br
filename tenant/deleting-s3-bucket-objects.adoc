...
+
image:delete-bucket-objects-in-progress.png["captura de tela mostrando objetos de bucket sendo excluídos"]
...
+
image:delete-bucket-objects-complete.png["captura de tela mostrando todos os objetos bucket excluídos"]
