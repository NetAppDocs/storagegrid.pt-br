...
* *s3-configurations*: Operações para recuperar configurações globais do S3.
...
image:tenant_api_swagger_example.gif["Exemplo mostrando a operação GET Groups na Swagger API"]
