...
image:tenant_dashboard_with_buckets.png["Painel de instrumentos - Lista de baldes"]
...
+
image:tenant_dashboard_buckets.png["Baldes do painel do locatário"]
...
image:tenant_dashboard_endpoint_error.png["Painel mostrando a mensagem de endpoint"]
