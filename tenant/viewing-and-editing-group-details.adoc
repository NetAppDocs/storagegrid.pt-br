...
---
= Visualize e edite os detalhes do grupo de locatários em StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_group_details.png["Ver detalhes do grupo"]
...
+
.. Opcionalmente, selecione o nome de exibição ou o ícone de edição image:icon_edit_tm.png["Ícone de edição"] para atualizar o nome de exibição.
+
