...
NOTE: CloudMirror replication só é compatível se o bucket de origem tiver o Bloqueio de Objetos S3 ativado e o endpoint for um bucket S3 da Amazon ou do StorageGRID. As configurações do Bloqueio de Objetos não são replicadas para o endpoint do bucket.
