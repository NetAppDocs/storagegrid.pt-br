...
---
= Saiba mais sobre codificação de apagamento no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ec_three_sites_4_plus_2.png["Codificação de apagamento três locais 4 Plus 2"]
...
image:ec_recoverable_4_plus_2.png["Codificação de apagamento recuperável 4 Plus 2"]

Se mais de dois nós de storage forem perdidos, o objeto não poderá ser recuperado.

image:ec_unrecoverable_4_plus_2.png["Codificação de apagamento irrecuperável 4 Plus 2"]
