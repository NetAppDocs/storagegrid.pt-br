...
---
= Regras e política de ILM para proteger arquivos de imagem no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["Regra ILM 1 por exemplo 3: Use EC para arquivos de imagem maiores que 1 MB"]
...
image:policy_3_configured_policy.png["Política ILM, por exemplo, 3: Melhor proteção para arquivos de imagem"]
