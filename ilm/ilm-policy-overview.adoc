...
summary: 'Uma política de gerenciamento de ciclo de vida das informações (ILM) é um conjunto ordenado de regras ILM que determina como o sistema StorageGRID gerencia os dados de objetos ao longo do tempo.' 
---
= Saiba mais sobre as políticas ILM no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm-policies-single.png["Diagrama único de políticas ILM"]
...
image:ilm-policies-tags-conceptual.png["Diagrama de várias políticas ILM"]
