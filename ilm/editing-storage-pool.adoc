...
---
= Editar um pool de storage no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Depois de terminar
Se você adicionou um novo site ou nível de armazenamento a um pool de storage usado na política ILM ativa, ative uma nova política ILM para forçar o StorageGRID a usar o novo site ou nível de armazenamento. Por exemplo, clone sua política ILM existente e ative o clone. Consulte link:working-with-ilm-rules-and-ilm-policies.html["Trabalhe com regras ILM e políticas ILM"].
