...
---
= Insira detalhes e filtros para uma regra ILM do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:advanced_filtering_size_between.png["Exemplo de filtragem avançada para tamanho de objeto"]
...
image:advanced_filtering_multiple_rows.png["Exemplo de filtragem avançada para metadados do usuário"]
