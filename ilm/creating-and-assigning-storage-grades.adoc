...
---
= Crie e atribua níveis de storage no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Para cada nível de armazenamento personalizado que você deseja adicionar, selecione *Inserir* image:icon_nms_insert.gif["insira o ícone"] para adicionar uma linha.
.. Introduza uma etiqueta descritiva.
+
image:editing_storage_grades.gif["Página de classes de armazenamento"]

.. Selecione *aplicar alterações*.
.. Opcionalmente, se precisar modificar um rótulo salvo, selecione *Editar* image:icon_nms_edit.gif["ícone de edição"] e selecione *Aplicar alterações*.
+
...
+
.. Localize o nó de armazenamento na lista LDR e selecione o ícone *Editar* image:icon_nms_edit.gif["ícone de edição"].
.. Selecione o grau de armazenamento adequado na lista.
+
image:assigning_storage_grades_to_storage_nodes.gif["Página de classes de armazenamento"]
