...
---
= Crie um pool de storage no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Ao instalar StorageGRID 12.0 ou posterior em uma nova grid, os pools de storage são criados automaticamente para cada site. No entanto, se você instalou inicialmente StorageGRID 11.6 ou anterior, os pools de storage não são criados automaticamente para cada site.
...
+
Para remover uma entrada, selecione o ícone de excluir image:icon_x_to_remove.png["eliminar ícone"].
