...
summary: Um pool de storage em nuvem especifica um único bucket externo do Amazon S3, outro provedor compatível com S3 ou um contêiner do Azure Blob Storage. 
---
...
[role="lead"]
Um pool de storage em nuvem especifica um único bucket externo do Amazon S3, outro provedor compatível com S3 ou um contêiner do Azure Blob Storage.
