...
summary: Você pode editar um pool de armazenamento em nuvem para alterar seu nome, ponto de extremidade de serviço ou outros detalhes; no entanto, você não pode alterar o bucket do S3 ou o contêiner do Azure para um pool de armazenamento em nuvem. 
---
= Editar um Cloud Storage Pool no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
