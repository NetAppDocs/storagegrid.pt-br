...
summary: Você pode editar um Cloud Storage Pool para alterar seu nome, endpoint de serviço ou outros detalhes. No entanto, você não pode alterar o bucket do S3 ou o container do Azure para um Cloud Storage Pool. 
---
