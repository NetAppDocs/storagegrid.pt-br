...
---
= Regras e política de ILM para filtragem de tamanho de objetos EC no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_2_rule_1_ec_objects_adv_filtering.png["Regra ILM 1 por exemplo 2: Use EC para todos os objetos com mais de 1 MB"]
