...
---
= Regras e políticas do ILM para proteção básica de objetos e retenção no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_two_copies_two_data_centers.png["Regra ILM 1 por exemplo 1: Copiar dados de objeto para dois sites"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["Regra ILM 2 por exemplo 1: Perfil de codificação de apagamento com correspondência de intervalo"]
...
+
image:policy_1_configured_policy.png["Política de ILM, por exemplo, 1"]
