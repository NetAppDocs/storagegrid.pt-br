...
summary: 'A etapa Definir posicionamentos do assistente Criar regra ILM permite definir as instruções de posicionamento que determinam por quanto tempo os objetos são armazenados, o tipo de cópias (replicadas ou codificação de apagamento), o local de armazenamento e o número de cópias.' 
---
= Defina as instruções de posicionamento para uma regra ILM do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_create_ilm_rule_wizard_2.png["Criar Assistente de regras ILM passo 2"]
...
+
image:ilm_rule_retention_diagram.png["Diagrama de retenção de regras ILM"]
