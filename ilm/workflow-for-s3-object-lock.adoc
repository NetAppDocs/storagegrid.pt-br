...
---
= Fluxo de trabalho do S3 Object Lock no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Saiba mais sobrelink:requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets["Requisitos de bloqueio de objeto S3"]
