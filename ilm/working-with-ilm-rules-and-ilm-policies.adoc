...
---
= Trabalhe com políticas ILM e regras ILM no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:ilm_rule_details_page.png["Página de detalhes da regra ILM"]
...
+
Você pode selecionar o ponto de interrogação image:icon_nms_question.png["ícone de ponto de interrogação"] para ver uma descrição dos itens na guia ILM.

+
image:ilm_metrics_on_dashboard.png["Métricas ILM no painel do Grid Manager"]
