...
summary: 'A etapa 3 (Selecionar comportamento de ingestão) do assistente Criar regra ILM permite que você escolha como os objetos filtrados por esta regra são protegidos durante a ingestão.' 
---
= Selecione o comportamento de ingestão para uma regra ILM do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
