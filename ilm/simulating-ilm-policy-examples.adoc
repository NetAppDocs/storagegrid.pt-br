...
---
= Exemplo de simulações de políticas ILM no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:simulate_policy_screen.png["Simule os resultados da política"]
...
+
image:simulate_reorder_rules_pngs_result.png["Exemplo 2: Reordenando regras ao simular uma política ILM"]
...
+
image:simulate_reorder_rules_correct_result.png["Exemplo 2: Reordenando regras ao simular uma política ILM"]
...
image:simulate_results_for_object_wrong_metadata.png["Exemplo 3: Corrigindo uma regra ao simular uma política ILM"]
...
+
image:simulate_results_for_object_corrected_metadata.png["Exemplo 3: Corrigindo uma regra ao simular uma política ILM"]
