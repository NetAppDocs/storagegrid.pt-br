...
---
= Riscos da replicação de cópia única no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_replication_make_1_copy.png["ILM replicação fazer cópia 1"]
...
image:ilm_replication_make_1_copy_sn_fails.png["ILM Replication Make 1 Copy SN falha"]
...
image:ilm_replication_make_2_copies_sn_fails.png["Replicação ILM Faça 2 cópias SN falha"]
