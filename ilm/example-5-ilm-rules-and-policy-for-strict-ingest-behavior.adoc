...
---
= Regras e política de ILM para comportamento de ingestão estrito no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:ilm_rule_1_example_5_strict_ingest.png["Regra ILM 1 exemplo 5 ingestão rigorosa"]
