...
summary: StorageGRID 12.0 utiliza a versão 4 da Tenant Management API. A versão 4 descontinua a versão 3. No entanto, as versões 1, 2 e 3 ainda são suportadas. 
---
