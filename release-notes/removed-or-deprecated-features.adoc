...
sidebar: sidebar 
keywords:  
summary: Saiba mais sobre os recursos e funcionalidades que foram removidos ou descontinuados no StorageGRID 12.0. Antes de atualizar, verifique se algum recurso removido ou descontinuado afeta seus aplicativos cliente ou a configuração da grade. 
---
...
[role="lead"]
Saiba mais sobre os recursos e funcionalidades que foram removidos ou descontinuados no StorageGRID 12.0. Antes de atualizar, verifique se algum recurso removido ou descontinuado afeta seus aplicativos cliente ou a configuração da grade.
