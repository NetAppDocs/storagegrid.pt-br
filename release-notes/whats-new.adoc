...
summary: StorageGRID 12.0 expande a capacidade de storage de objetos, aprimora o suporte a cargas de trabalho de IA/ML, fortalece a federação de grids, simplifica o gerenciamento do sistema e aumenta a segurança em toda a plataforma. 
---
...
[role="lead"]
StorageGRID 12.0 expande a capacidade de storage de objetos, aprimora o suporte a cargas de trabalho de IA/ML, fortalece a federação de grids, simplifica o gerenciamento do sistema e aumenta a segurança em toda a plataforma.

Para obter detalhes sobre problemas corrigidos e problemas conhecidos nas versões recentes do StorageGRID 12.0, consulte a  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["StorageGRID 12.0 Notas de lançamento"^]. Você precisa fazer login com sua conta NetApp ou criar uma conta para acessar as notas de versão.
