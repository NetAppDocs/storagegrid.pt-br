...
---
= Resolver o alerta de sobreposição de marca d'água no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_object_data_used_with_alert.png["Página de nós mostrando dados de objeto usados para 3 SnS"]
...
.. Desça a página até a tabela de armazenamentos de objetos.
