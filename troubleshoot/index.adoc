...
* link:../monitor/manually-triggering-autosupport-package.html["Acione manualmente um pacote AutoSupport"]
...
[cols="1a,2a,4a"]
|===
| image:feature_checkmark.gif["marca de verificação"] | Item | Notas 
