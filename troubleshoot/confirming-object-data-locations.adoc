...
---
= Confirme as localizações dos dados dos objetos no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:object_lookup.png["Página de pesquisa de objetos"]
...
+
image:object_lookup_results.png["Resultados da Pesquisa de objetos"]
