...
summary: Quando o alerta de objetos potencialmente perdidos for acionado, você deve investigar imediatamente. Colete informações sobre os objetos afetados e entre em contato com o suporte técnico. 
---
= Resolver o alerta de objetos potencialmente perdidos no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
O suporte técnico poderá solicitar que você verifique se há algum procedimento de recuperação de armazenamento em andamento. Consulte:
