...
---
= Saiba mais sobre falhas de armazenamento de objetos para volumes de storage no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_storage_nodes_storage_tables.png["Tabelas de storage de nós de storage"]
