...
---
= Configure os nós e sites recém-adicionados no StorageGRID.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Se o single sign-on (SSO) estiver habilitado para o seu sistema StorageGRID, crie uma relying party trust para o novo Admin Node. Você não pode fazer login no nó até criar essa relying party trust. Consulte como configurar o SSO usando link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] ou link:../admin/learn-about-setting-up-sso-saml.html["SAML"].
