...
---
= Diretrizes para adicionar capacidade de metadados no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:metadata_space_after_expansion.png["Diagrama dos metadados redistribuídos após dois nós de storage adicionados"]
