...
---
= Implante novos nós de grade no StorageGRID.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
. link:../swnodes/deploying-storagegrid-node-as-virtual-machine.html["Implante o novo nó como máquina virtual"]e conectá-lo a uma ou mais redes StorageGRID .
+
...
.Antes de começar
* Você tem as instruções para instalar o StorageGRID para sua versão do Linux e revisou olink:../swnodes/index.html["requisitos de hardware e armazenamento"] .
...
. Se você precisar acessar manualmente a página de instalação do Monitor, selecione *Monitor Installation* na barra de menu.
+
A página de instalação do Monitor mostra o progresso da instalação.
