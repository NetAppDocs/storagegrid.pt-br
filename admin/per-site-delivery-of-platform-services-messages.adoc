...
---
= Entrega por local de mensagens dos serviços da plataforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:notification_multiple_sites.gif["Diagrama mostrando que a ação no objeto no site 1 aciona a notificação do site 1"]
...
image:notifications_site_2.gif["diagrama mostrando ação no objeto do site 2 aciona notificações do site 2"]
