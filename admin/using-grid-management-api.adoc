...
.Passos
. No cabeçalho do Gerenciador de Grade, selecione o ícone de ajuda image:icon_help_menu_bar.png["Ícone de ajuda"] e selecione *API documentation*.
...
+
image:swagger_example.png["Exemplo de Swagger UI"]
