...
StorageGRID suporta vários provedores de identidade SSO (IdP).

[role="tabbed-block"]
====
.OIDC
--
Os seguintes SSO IdPs são suportados para OpenID Connect (OIDC):
...
.SAML
--
Os seguintes SSO IdPs são compatíveis com Security Assertion Markup Language 2.0 (SAML 2.0):
