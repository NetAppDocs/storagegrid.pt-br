...
summary: 'Você pode não conseguir acessar o Grid Manager se o sistema de autenticação única (SSO) estiver inativo. Nesse caso, você pode desativar e reativar temporariamente o SSO para um Admin Node. Para desativar e depois reativar o SSO, você deve acessar o shell de comando do nó.' 
---
...
. Dependendo da sua configuração de SSO, execute um dos seguintes comandos:
+
[role="tabbed-block"]
====
.SAML
