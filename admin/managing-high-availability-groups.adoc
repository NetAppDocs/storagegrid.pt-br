...
summary: 'Os grupos de alta disponibilidade (HA) fornecem conexões de dados altamente disponíveis para clientes S3 e conexões altamente disponíveis para o Gerenciador de Grade e o Gerente do locatário.' 
---
= Saiba mais sobre os grupos de alta disponibilidade do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ha_group_primary_interface.png["Interface Principal Grupo HA"]
