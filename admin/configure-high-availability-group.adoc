...
---
= Configurar grupos de alta disponibilidade no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:ha_group_add_interfaces.png["Adicione interfaces"]
...
+
image:vlan_parent_interface_tooltip.png["Dica da ferramenta Interface VLAN"]
...
+
image:ha_group_determine_failover.png["Os GRUPOS HA determinam a ordem de prioridade"]
...
+
image:ha_group_select_virtual_ips.png["Os GRUPOS HA entram em VIPs"]
