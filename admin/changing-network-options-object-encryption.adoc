...
NOTE: A partir do StorageGRID 12.1.0, o suporte para criptografia AES-128 de novos dados de objetos armazenados em repouso está obsoleto. O suporte continua para a recuperação de objetos armazenados que foram originalmente criptografados com AES-128.
