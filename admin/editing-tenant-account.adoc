...
---
= Editar uma conta de locatário do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Selecione a aba Grid federation na página de detalhes do locatário.
... Selecione a conexão que você deseja remover.
