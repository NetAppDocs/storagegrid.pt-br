...
summary: 'StorageGRID utiliza uma Autoridade Certificadora (CA) interna para proteger o tráfego interno. Este certificado não se altera caso você carregue seus próprios certificados.' 
---
= Copie o certificado CA do StorageGRID Grid
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
