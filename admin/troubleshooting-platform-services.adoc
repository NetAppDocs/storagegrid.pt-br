...
summary: Os endpoints usados nos serviços da plataforma são criados e mantidos pelos usuários do tenant no Tenant Manager. No entanto, se um tenant tiver problemas para configurar ou usar os serviços da plataforma, você pode usar o Grid Manager para ajudar a resolver o problema. 
---
...
+
image:nodes_page_site_level_platform_services.gif["Serviços de plataforma em nível de site"]
