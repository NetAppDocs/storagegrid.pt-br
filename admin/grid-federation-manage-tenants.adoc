...
+
image:grid-federation-tenant-detail.png["Separador Grid Federation (federação de grelha) na página de detalhes do locatário"]
...
image:grid-federation-remove-permission.png["etapas para remover a conexão de federação de grade"]
...
+
image:grid-federation-remove-permission-error.png["mensagem de erro exibida se o locatário tiver cgr habilitado para um bucket"]
