...
image:grid-federation-workflow.png["Fluxo de trabalho de conexão de federação de grade"]
...
+
Para obter detalhes sobre os requisitos de versão, consulte a  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Notas de lançamento"^]. Você precisa fazer login com sua conta NetApp ou criar uma conta para acessar as Release notes.
...
image:grid-federation-certificates.png["Certificados de federação de grade"]
