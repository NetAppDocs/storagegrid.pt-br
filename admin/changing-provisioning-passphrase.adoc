...
---
= Alterar a senha de provisionamento do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:change_provisioning_passphrase_success.png["Mensagem de sucesso para a senha de provisionamento alterada"]
