...
image:link_costs.gif["Diagrama conceitual para custos de ligação entre data centers"]
...
+
image:configuring_link_costs.png["Custo da ligação"]
...
+
Para cancelar as alterações, selecione image:nms_revert.gif["anular ícone"]*Reverter*.
