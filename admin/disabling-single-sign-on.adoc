...
summary: 'Você pode desativar o logon único (SSO) se não quiser mais usar essa funcionalidade. Você deve desativar o logon único antes de desativar a federação de identidade.' 
---
= Desativar SSO no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
