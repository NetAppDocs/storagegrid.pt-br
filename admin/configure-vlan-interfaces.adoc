...
+
image:vlan_create_parent_interfaces.png["VLAN criar interfaces pai do assistente"]
...
** Se você precisar remover uma interface principal, selecione a lixeira image:icon_trash_can.png["ícone da lata de lixo"].
