...
summary: 'Você pode criar interfaces de LAN virtual (VLAN) em Admin Nodes e Gateway Nodes e usá-las em grupos de HA e endpoints de load balancer para isolar e particionar o tráfego para segurança, flexibilidade e desempenho.' 
---
= Configurar interfaces VLAN no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:vlan-create-parent-interfaces.png["VLAN criar interfaces pai do assistente"]
...
** Se você precisar remover uma interface principal, selecione a lixeira image:icon-trash-can.png["ícone da lata de lixo"].
