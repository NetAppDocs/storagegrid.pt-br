...
. Se o banner *FabricPool and S3 setup wizard* aparecer no painel, selecione o link no banner. Se o banner não aparecer mais, selecione o ícone de ajuda image:icon_help_menu_bar.png["Ícone de ajuda"] na barra de cabeçalho no Grid Manager e selecione *FabricPool and S3 setup wizard*.
...
** Selecione o ícone de copiar (image:icon_tenant_copy_url.png["ícone de cópia"]) para copiar o ID da chave de acesso e a chave de acesso secreta para a área de transferência.
