...
summary: À medida que os nós de armazenamento atingem a capacidade, você deve expandir o StorageGRID adicionando novo storage. Você pode fazer isso adicionando volumes de armazenamento, prateleiras de expansão de storage e nós de armazenamento. 
---
