...
summary: 'À medida que os nós de armazenamento atingem a capacidade, você deve expandir o sistema StorageGRID por meio da adição de novo storage. Existem três opções disponíveis: adicionar volumes de armazenamento, adicionar prateleiras de expansão de storage e adicionar nós de armazenamento.' 
---
= Gerencie nós de armazenamento completos no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
