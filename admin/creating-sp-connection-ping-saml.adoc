...
---
= Crie conexões de provedor de serviços no PingFederate para SAML no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Use o PingFederate para criar uma conexão de provedor de serviços (SP) para cada nó Admin para SAML em seu sistema. Para agilizar o processo, você importará os metadados SAML do StorageGRID.
