...
summary: 'Se você enviar pacotes AutoSupport usando HTTP ou HTTPS, poderá configurar um servidor proxy não transparente entre nós de administração e suporte técnico (AutoSupport).' 
---
= Configurar as definições de proxy de administrador no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obter mais informações sobre AutoSupport, consulte link:../monitor/configure-autosupport-grid-manager.html["Configurar o AutoSupport"].
