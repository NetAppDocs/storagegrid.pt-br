...
---
= Gerenciar o acesso SSH externo no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Requer acesso à porta 22 entre o laptop de serviço e todos os outros nós da grade.  Remova o acesso à porta 22 ao concluir a tarefa de manutenção.
