...
summary: Se uma tentativa de envio de um AutoSupport pacote falhar, o sistema StorageGRID toma ações diferentes dependendo do tipo de AutoSupport pacote. 
---
= Solucionar problemas dos pacotes AutoSupport do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
