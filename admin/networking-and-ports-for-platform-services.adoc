...
* Um endpoint de webhook externo ou hospedado localmente que suporta solicitações de notificação HTTP POST.
+
Esse endpoint pode ser hospedado em vários servidores da Web, frameworks ou ferramentas do Data Processing, como o Fluentd.
