...
summary: 'Um servidor de gerenciamento de chaves (KMS) é um sistema externo de terceiro que fornece chaves de criptografia para os nós do appliance StorageGRID no site StorageGRID associado, usando o Key Management Interoperability Protocol (KMIP)' 
---
