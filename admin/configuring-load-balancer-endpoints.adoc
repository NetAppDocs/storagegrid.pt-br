...
Se você estiver configurando pontos de extremidade do balanceador de carga para um link:../admin/configure-global-namespace.html["espaço de nomes global"], use a mesma porta para cada ponto de extremidade.
...
+
image:load_balancer_endpoint_details.png["Detalhes do ponto de extremidade do balanceador de carga"]
...
.. Selecione o ícone de edição image:icon_edit_tm.png["Ícone de edição"].
.. Introduza o novo nome.
.. Selecione *Guardar*.
