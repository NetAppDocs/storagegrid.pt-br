...
image:grid-federation-cross-grid-replication-one-direction.png["imagem mostrando a conexão de federação de grade em uma direção"]
...
image:grid-federation-cross-grid-replication.png["imagem mostrando replicação em uma direção em comparação com a replicação em ambas as direções"]
...
image:grid-federation-cross-grid-replication-delete.png["imagem que mostra a eliminação do cliente replicado em ambas as grelhas"]
