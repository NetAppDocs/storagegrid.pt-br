...
---
= Estime o tempo necessário para concluir uma atualização do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Exemplo: tempo estimado para atualização para StorageGRID 12.1
...
+
Você deve reservar até 18 horas para concluir a atualização do seu sistema para StorageGRID 12.1.0.
