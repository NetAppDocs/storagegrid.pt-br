...
---
= Implante nós de grid como máquinas virtuais para StorageGRID com VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Você pode precisar remapear uma porta se as políticas de rede da sua empresa restringirem o acesso a uma ou mais portas usadas pelo StorageGRID. Consulte link:../network/index.html["Diretrizes de rede"] para ver as portas usadas pelo StorageGRID.
