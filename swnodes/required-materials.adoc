...
---
= Informações e materiais necessários para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
Consulte link:../network/index.html["Diretrizes de rede"].
...
+
--
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Notas de lançamento"^]. Você precisa fazer login com sua NetApp conta ou criar uma conta para acessar as notas de versão.
