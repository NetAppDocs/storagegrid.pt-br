...
----
* Desative AppArmor completamente. Para Ubuntu 9.10 ou posterior, siga as instruções em  https://help.ubuntu.com/community["Comunidade online do Ubuntu"]. Desativar AppArmor completamente pode não ser possível em versões mais recentes do Ubuntu.
+
