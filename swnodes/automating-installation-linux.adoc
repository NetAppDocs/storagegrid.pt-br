...
summary: Você pode automatizar a instalação do serviço de host do StorageGRID e a configuração dos nós de grid no Linux. 
---
= Automatize a instalação do serviço de host do StorageGRID e a configuração dos nós de grid no Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
