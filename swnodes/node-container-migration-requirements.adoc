...
---
= Requisitos de migração de contêiner de nó do StorageGRID para Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:eth0_bond.gif["Esta imagem é explicada pelo texto circundante."]
...
image:block_device_mapping_rhel.gif["Mapeamento de dispositivos de bloco"]
