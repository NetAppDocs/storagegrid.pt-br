...
---
= Valide a configuração do StorageGRID no Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:rhel_node_configuration_file_output.gif["Esta imagem é explicada pelo texto circundante."]
...
image:rhel_node_configuration_file_output_with_errors.gif["Esta imagem é explicada pelo texto circundante."]
