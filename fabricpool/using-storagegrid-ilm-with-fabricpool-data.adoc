...
* Se você atualizou para StorageGRID 12.1 a partir de uma versão do StorageGRID anterior à 11.7, você já configurou o pool de storage que usará. Em geral, você deve criar um pool de storage para cada site do StorageGRID que usará para armazenar dados. (A partir da versão 11.7, pools de storage são criados automaticamente para cada site.)
+
