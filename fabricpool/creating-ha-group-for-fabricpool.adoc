...
summary: 'Ao configurar StorageGRID para uso com FabricPool, você pode opcionalmente criar um ou mais grupos de alta disponibilidade (HA).' 
---
= Crie um grupo de alta disponibilidade (HA) para FabricPool no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
