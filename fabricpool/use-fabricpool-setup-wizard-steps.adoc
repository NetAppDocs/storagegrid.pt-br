...
---
= Acesse e conclua o assistente de instalação do StorageGRID FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
. Opcionalmente, selecione o ícone de copiar (image:icon_tenant_copy_url.png["ícone de cópia"]) para copiar o ID da chave de acesso e a chave de acesso secreta para a área de transferência.
+
