...
---
= Configure as entradas do servidor DNS para StorageGRID com FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Entradas DNS para solicitações no estilo virtual-hosted

Se você definiu link:../admin/configuring-s3-api-endpoint-domain-names.html["S3 nomes de domínio de endpoint"] e utilizará solicitações no estilo de hospedagem virtual, adicione entradas DNS para todos os nomes de domínio de endpoint S3 necessários, incluindo quaisquer nomes curinga.
