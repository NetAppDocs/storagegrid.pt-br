...
* Para dispositivos sem unidades SED, FDE ou FIPS, use um Key Management Server (KMS) para  https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/optional-enabling-node-encryption.html#enable-node-encryption["Ative e configure a criptografia do nó do software StorageGRID"^].
