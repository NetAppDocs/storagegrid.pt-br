...
---
= Monitore os recursos de rede e do sistema no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:traffic_classification_policies_main_screen_w_examples.png["Política de tráfego para exemplo de gráfico"]

.. Para visualizar gráficos que mostram as métricas de rede associadas a uma política, selecione o botão de opção à esquerda da política e, em seguida, selecione *Métricas*.
