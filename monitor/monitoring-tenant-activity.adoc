...
---
= Monitore a atividade do tenant no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_accounts_page.png["Página de contas de inquilino"]

. Opcionalmente, faça Sign in em uma conta de locatário selecionando o link de Sign in image:icon_tenant_sign_in.png["Ícone de login do locatário"] na coluna *Sign in/Copiar URL*.
. Opcionalmente, copie o URL da página de Sign in de um locatário selecionando o link Copiar URL image:icon_tenant_copy_url.png["Ícone de URL de cópia do locatário"] na coluna *Sign in/Copiar URL*.
...
+
image:tenant_accounts_example_csv.png["Exemplo de contas de inquilino .csv"]
...
+
image:tenant_usage_modal.png["Modal de uso do locatário"]
...
+
image:tenant_bucket_space_consumption_GM.png["Gráfico de barras de consumo do balde do locatário"]
...
+
image:tenant_bucket_details_csv.png["Exemplo de CSV de detalhes do intervalo do locatário"]
