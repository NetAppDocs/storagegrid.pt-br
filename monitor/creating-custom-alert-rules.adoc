...
---
= Crie regras de alerta personalizadas no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alerts_create_custom_rule.png["Alertas > Criar regra personalizada"]
...
+
Para visualizar métricas disponíveis e testar expressões do Prometheus, selecione o ícone de ajuda image:icon_nms_question.png["ícone de ponto de interrogação"] e siga o link para a seção Métricas da API de Gerenciamento de Grid.
