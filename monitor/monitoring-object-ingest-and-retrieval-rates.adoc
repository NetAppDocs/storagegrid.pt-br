...
---
= Monitore as operações do cliente S3 no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_storage_node_objects_help.png["captura de tela de Nodes > _Storage Node_ > Objects > ajuda de atributo"]
