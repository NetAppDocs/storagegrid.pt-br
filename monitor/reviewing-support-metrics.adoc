...
---
= Analisar métricas de suporte do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Para consultar os valores atuais das métricas do StorageGRID e visualizar gráficos desses valores ao longo do tempo, selecione o link na seção Prometheus.
+
...
. Para acessar painéis pré-construídos contendo gráficos das métricas do StorageGRID ao longo do tempo, selecione os links na seção Grafana.
+
