...
---
= Visualize a guia SANtricity System Manager do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Para usar SANtricity System Manager para configurar um proxy para E-Series AutoSupport, consulte link:sending-eseries-autosupport-messages-through-storagegrid.html["Envie pacotes e-Series AutoSupport através do StorageGRID"].
...
image:nodes_page_santricity_tab.png["Guia SANtricity da página de nós"]
