...
sidebar: sidebar 
keywords: bycast, log 
summary: O arquivo /var/local/log/bycast.log é o principal arquivo de solução de problemas do software StorageGRID. Existe um arquivo bycast.log para cada nó da grade. O arquivo contém mensagens específicas para esse nó da grade. 
---
= Saiba mais sobre o bycast.log do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
