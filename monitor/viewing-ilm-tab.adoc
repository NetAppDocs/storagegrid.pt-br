...
sidebar: sidebar 
keywords: ilm tab 
summary: 'A guia ILM fornece informações sobre as operações de gerenciamento do ciclo de vida das informações (ILM).' 
---
= Visualize a guia StorageGRID ILM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_ilm_tab.png["Guia ILM da página de nós"]
