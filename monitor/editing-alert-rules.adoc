...
---
= Editar regras de alerta no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alert_rules_edit_rule.png["Alertas > Editar regra"]
...
+
image:alert_rules_edit_revert_to_default.png["Regras de alerta: Revertendo uma condição editada para o valor padrão"]
