...
---
= Visualize e gerencie o dashboard no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard.png["Painel do Grid Manager"]
...
|===
Algumas das cartas podem ser maximizadas para facilitar a visualização. Selecione o ícone de maximizar image:icon_dashboard_card_maximize.png["Ícone maximizar"] no canto superior direito da carta. Para fechar uma carta maximizada, selecione o ícone de minimizar image:icon_dashboard_card_minimize.png["Ícone minimizar"] ou selecione *Close*.
...
image:dashboard_manage.png["Gerenciar painéis"]
...
image:dashboard_configure.png["Configure o painel de instrumentos"]
