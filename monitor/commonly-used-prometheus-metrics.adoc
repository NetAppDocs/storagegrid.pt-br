...
Para obter detalhes sobre a sintaxe das consultas do Prometheus, consulte  https://prometheus.io/docs/prometheus/latest/querying/basics/["Noções básicas de consulta"^].
...
+
image:nodes_page_network_traffic_graph.png["Gráfico de Prometheus"]
