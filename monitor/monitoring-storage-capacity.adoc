...
---
= Monitore a capacidade de storage no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:dashboard_data_and_metadata_space_usage_breakdown.png["Divisão de utilização de espaço de dados e metadados"]
...
+
image:dashboard_storage_over_time.png["Gráfico de armazenamento ao longo do tempo"]
...
+
image:nodes_deployment_storage_tab.png["Guia de storage de implantação de nós"]
...
image:calculating_watermarks.gif["Desenho conceitual para espaço total utilizável"]
...
+
image:nodes_page_storage_used_object_data.png["Dados de objetos usados no storage de páginas de nós"]
...
NOTE: Para visualizar gráficos desses valores, clique nos ícones de gráfico image:icon_chart_new_for_11_5.png["Ícone de carta"] nas colunas Disponíveis.

+
image:nodes_page_storage_tables.png["Objeto armazena tabelas"]
...
image:forecast-metadata-usage.png["Previsão do uso de metadados por local"]
