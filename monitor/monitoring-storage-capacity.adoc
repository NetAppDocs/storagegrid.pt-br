...
NOTE: Para visualizar gráficos desses valores, selecione os ícones de gráfico nas colunas disponíveis.
...
image:forecast_metadata_usage.png["Previsão do uso de metadados por local"]
