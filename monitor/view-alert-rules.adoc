...
---
= Visualizar regras de alerta do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alert_rules_page.png["Página de regras de alerta"]
...
** *Crítico* image:icon_alert_red_critical.png["Ícone Alerta Vermelho crítico"]: Existe uma condição anormal que interrompeu o funcionamento normal de um nó ou serviço do StorageGRID. Você deve resolver o problema imediatamente. A não resolução do problema pode resultar em interrupção do serviço e perda de dados.
