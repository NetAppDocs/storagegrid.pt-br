...
---
= Silenciar notificações de alerta no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alerts_silences_page.png["Alertas > página de silenciamentos"]
...
+
image:alerts_create_silence.png["Alertas > Criar Silêncio"]
