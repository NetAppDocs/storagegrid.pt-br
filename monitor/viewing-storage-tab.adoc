...
---
= Visualize a guia Storage do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
A aba Armazenamento é exibida para todos os nós, cada site e toda a grade. Esta aba contém as seguintes informações:

Armazenamento de gráficos usados:: Para nós de storage, cada local e toda a grade, a guia Storage inclui gráficos mostrando quanto de storage foi usado pelos dados de objeto e metadados de objeto ao longo do tempo.
...
image:nodes_storage_node_storage_tab.png["Nós > Nó de armazenamento > Aba armazenamento"]
