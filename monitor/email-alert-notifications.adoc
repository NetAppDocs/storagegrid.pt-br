...
+
Selecione o ícone de mais image:icon_plus_sign_black_on_white.gif["ícone plus"] para adicionar destinatários.
...
NOTE: Se precisar editar as configurações de e-mail, selecione o ícone de lápis image:icon_edit_tm.png["Ícone de edição"] para atualizar este campo.
