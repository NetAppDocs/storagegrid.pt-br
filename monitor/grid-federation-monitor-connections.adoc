...
---
= Monitorar conexões de federação de grid do StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:grid-federation-connections-tab.png["Separador ligações de federação de grelha"]
...
+
image:grid-federation-permitted-tenants-tab.png["Guia locatários permitidos da federação de grade"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["grid-federação-permitida-tenants-tab-for-connection"]
