...
+
image:grid_federation_connections_tab.png["Separador ligações de federação de grelha"]
...
+
image:grid_federation_permitted_tenants_tab.png["Guia locatários permitidos da federação de grade"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["grid-federação-permitida-tenants-tab-for-connection"]
