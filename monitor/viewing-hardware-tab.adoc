...
+
image:nodes_page_hardware_tab_for_appliance.png["Guia hardware da página de nós para o dispositivo"]
...
+
image:nodes_page_network_communication.png["Comunicação de rede de Página de nós"]
...
+
image:nodes_page_storage_tables.png["Tabelas de storage de páginas de nós"]
...
+
image:nodes_page_hardware_tab_services_appliance.png["Página nós guia hardware para o dispositivo de serviços"]
...
.. Reveja a secção interfaces de rede.
+
image:nodes_page_hardware_tab_network_services_appliance.png["Página de nós Guia hardware dispositivo de Serviços de rede"]
...
+
image:nodes_page_storage_tab_services_appliance.png["Dispositivo de serviços de guia de storage da página nós"]
