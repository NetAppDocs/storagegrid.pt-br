...
---
= Crie aplicativos de monitoramento personalizados para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para visualizar as operações da API de métricas, incluindo a lista completa das métricas disponíveis, acesse o Grid Manager. Na parte superior da página, selecione o ícone de ajuda e selecione *API documentation* > *métricas*. image:help_api_docs_metrics.png["Seção de métricas de documentação da API de Ajuda"]
