...
Esta documentação não concede nenhuma licença ou outros direitos sobre a API REST do StorageGRID S3. Qualquer uso ou acesso à API REST do StorageGRID S3 requer e está sujeito a um contrato de licença separado com a NetApp.
