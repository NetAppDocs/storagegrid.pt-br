...
---
= Saiba mais sobre os tipos e códigos de mensagens de auditoria no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
----
Para obter informações sobre como definir níveis de mensagens de auditoria, alterar destinos de log e usar um servidor syslog externo para suas informações de auditoria, consultelink:../monitor/configure-log-management.html["Configurar gerenciamento de log e servidor syslog externo"]
