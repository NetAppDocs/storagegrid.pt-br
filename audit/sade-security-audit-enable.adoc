...
summary: 'Esta mensagem indica que o serviço de origem (ID do nó) restaurou o registro de mensagens de auditoria. StorageGRID está novamente coletando e entregando mensagens de auditoria.' 
---
= Mensagem de auditoria SADE para ativação da auditoria de segurança no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esta mensagem indica que o serviço de origem (ID do nó) restaurou o registro de mensagens de auditoria. StorageGRID está novamente coletando e entregando mensagens de auditoria.
