...
summary: 'Esta mensagem é gerada quando uma tentativa de conexão usando TLS (Transport Layer Security) falhou.' 
---
= Mensagem de auditoria ETAF para falhas de autenticação de segurança no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
