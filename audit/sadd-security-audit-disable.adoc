...
summary: 'Esta mensagem indica que o serviço de origem (ID do nó) desativou o registro de mensagens de auditoria. StorageGRID não está mais coletando nem entregando mensagens de auditoria.' 
---
= Mensagem de auditoria SADD para desativação da auditoria de segurança no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esta mensagem indica que o serviço de origem (ID do nó) desativou o registro de mensagens de auditoria. StorageGRID não está mais coletando nem entregando mensagens de auditoria.
