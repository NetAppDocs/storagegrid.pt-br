...
image:audit_message_flow.gif["Diagrama que resume o fluxo de mensagens de auditoria através de relés"]
...
image:audit_message_retention.gif["Diagrama que resume o recebimento da mensagem de auditoria no AMS"]
