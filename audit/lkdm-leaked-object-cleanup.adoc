...
summary: A mensagem de auditoria LKDM é gerada quando um fragmento vazado é limpo ou excluído. 
---
= Mensagem de auditoria LKDM para limpeza de objeto vazado no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
