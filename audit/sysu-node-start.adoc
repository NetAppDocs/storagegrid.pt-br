...
summary: 'Quando um serviço é reiniciado, essa mensagem é gerada para indicar se o desligamento anterior foi limpo (comandado) ou desordenado (inesperado).' 
---
= Mensagem de auditoria SYSU para nó inicia no StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
