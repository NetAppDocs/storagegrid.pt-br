...
---
= Explore o StorageGRID Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard_and_menu.png["Painel no Gerenciador de Grade"]

Para obter uma explicação das informações exibidas em cada cartão, selecione o ícone de ajuda image:icon_nms_question.png["ícone de ponto de interrogação"] para esse cartão.
...
O menu de ajuda image:icon_help_menu_bar.png["ícone de ajuda na barra de menus"] fornece acesso a:
...
* Configure as notificações por e-mail para alertas do StorageGRID
...
* Use link:../admin/grid-federation-overview.html["federação de grade"] para sincronizar informações de contas de locatários e replicar dados de objetos entre dois sistemas StorageGRID
...
* link:../monitor/configure-email-server.html["Configurar servidor de e-mail"]
...
* link:../admin/about-multi-admin-verify.html["Configurar verificação multi-admin"]
...
* Restauração de dados de objetos
+
...
* link:../monitor/configure-autosupport-grid-manager.html["Configurar o AutoSupport"]
