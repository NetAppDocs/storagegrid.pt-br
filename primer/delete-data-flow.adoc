...
Consulte link:../ilm/how-objects-and-delete-markers-are-deleted.html["Como os objetos e os marcadores de exclusão são excluídos"] para mais informações.
...
image:delete_data_flow.png["Fluxo de dados de eliminação do cliente"]
...
image:automatic_deletion_data_flow.png["Fluxo de dados de exclusão automática"]
