...
summary: 'Você usa gerenciamento do ciclo de vida das informações (ILM) para controlar o posicionamento, a duração e o comportamento de ingestão de todos os objetos no seu sistema StorageGRID. As regras do ILM determinam como o StorageGRID armazena objetos ao longo do tempo. Você configura uma ou mais regras do ILM e depois as adiciona a uma política do ILM.' 
---
...
image:ilm_policy_and_rules.png["Política e regras do ILM"]
