...
image:ilm_replication_make_2_copies.png["Regra de fazer 2 cópias"]
...
image:ec_three_sites_4_plus_2.png["Codificar para apagamento três locais 4 Plus 2"]
