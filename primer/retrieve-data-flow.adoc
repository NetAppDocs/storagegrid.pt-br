...
---
= Como StorageGRID lida com a recuperação de objetos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. O serviço LDR de origem retorna os dados do objeto recuperado para o serviço LDR consultado, e o sistema retorna o objeto para o aplicativo cliente.
